...
all_data_tables.to_excel(output_folder + basic_join_file, index=False)

# START CREATION OF A NEW FILE TO STORED ANOTHER PATTERN FILE...
read_data_join = pd.read_excel(output_folder + basic_join_file)
...
# SAVE AGAIN..
read_data_join.to_excel(output_folder + work_join_file, index=False)
